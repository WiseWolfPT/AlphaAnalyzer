-- Alfalyzer Database Schema (FIXED VERSION)
-- Run this in Supabase SQL Editor

-- Drop existing tables if needed (CAREFUL - this will delete data!)
...
-- Create triggers for updated_at (only for tables that have the column)
...
-- No trigger for cache_quotes as it only has updated_at (no need for trigger)

-- Success message
DO $$
BEGIN
  RAISE NOTICE 'Database schema created successfully!';
  RAISE NOTICE 'Tables created: users_metadata, watchlists, portfolios, price_alerts, cache_quotes';
