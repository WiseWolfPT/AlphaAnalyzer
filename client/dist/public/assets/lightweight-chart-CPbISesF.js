...
var _a;
import { r as reactExports, w as React, j as jsxRuntimeExports, f as cn } from "./index-DF734YkB.js";
/*!
 * @kurkle/color v0.3.4
...
Chart$1.register(CategoryScale, LinearScale, PointElement, LineElement, BarElement, ArcElement, plugin_title, plugin_tooltip, index, plugin_legend);
const LightweightChartContext = reactExports.createContext(null);
function useLightweightChart() {
  const context = reactExports.useContext(LightweightChartContext);
  if (!context) {
    throw new Error("useLightweightChart must be used within a <LightweightChartContainer />");
  }
  return context;
}
const LightweightChartContainer = reactExports.forwardRef(({
  className,
  children,
  config,
  title,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(LightweightChartContext.Provider, {
    value: {
      config
    },
    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ref,
      className: cn("flex flex-col space-y-3 p-6 bg-card rounded-lg border", className),
      ...props,
      children: [(title || subtitle) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        className: "space-y-1",
        children: [title && /* @__PURE__ */ jsxRuntimeExports.jsx("h3", {
...
const getBaseOptions = (isDarkMode = false) => ({
  responsive: true,
...
function LightweightBarChart({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    className: cn("h-full", className),
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, {
      data: chartData,
      options
    })
  });
...
function LightweightPieChart({
  data,
  className
}) {
  const isDarkMode = document.documentElement.classList.contains("dark");
  const colors2 = data.map((d) => d.color || `hsl(${Math.random() * 360}, 70%, 50%)`);
  const chartData = {
    labels: data.map((d) => d.label),
    datasets: [{
      data: data.map((d) => d.value),
      backgroundColor: colors2,
      borderColor: colors2.map((color2) => color2.replace("50%)", "40%)")),
      borderWidth: 2
    }]
  };
  const options = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
    className: cn("h-full", className),
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Doughnut, {
      data: chartData,
      options
    })
  });
}
function LightweightMiniChart({
  data,
  type = "area",
  color: color2 = "#10b981",
  height = 40,
  ...
  const chartData = {
    ...
    datasets: [{
      data: data.map((d) => d.value),
      borderColor: color2,
      backgroundColor: type === "area" ? `${color2}30` : "transparent",
      fill: type === "area",
      tension: 0.4,
      pointRadius: 0,
      borderWidth: 2
...
const ResponsiveContainer = LightweightChartContainer;
const BarChart = LightweightBarChart;
const LineChart = LightweightLineChart;
const AreaChart = LightweightPriceChart;
const PieChart = LightweightPieChart;
const XAxis = () => null;
const YAxis = () => null;
const CartesianGrid = () => null;
const Cell = () => null;
const ComposedChart = LightweightLineChart;
export {
  AreaChart,
  BarChart,
  CartesianGrid,
