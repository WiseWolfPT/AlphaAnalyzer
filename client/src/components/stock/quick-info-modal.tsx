        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <Link href={`/stock/${stock.symbol}/charts`} className="flex-1">
              <Button className="w-full bg-gradient-to-r from-teya-green via-teya-green-dark to-teya-green hover:from-teya-green-dark hover:via-teya-green hover:to-teya-green-dark text-rich-black font-semibold shadow-lg shadow-teya-green/30 hover:shadow-teya-green/50 hover:scale-105 transition-all duration-300 border-0" onClick={onClose}>
                <BarChart3 className="h-4 w-4 mr-2" />
                View Advanced Charts
              </Button>
            </Link>
            <Button variant="outline" size="icon" title="Company Website" className="border-teya-green/30 hover:border-teya-green hover:bg-teya-green/10">
