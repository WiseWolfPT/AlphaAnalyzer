  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="hero" className="relative overflow-hidden min-h-screen flex items-center">
        {/* Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-teal-600 via-cyan-700 to-slate-800" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen py-20">
            ...
            >
              ...
              <motion.p
                ...
                className="text-xl text-teal-100 mb-6 leading-relaxed max-w-lg"
              >
              ...
              <motion.p
                ...
                className="text-lg text-cyan-200 mb-8 leading-relaxed max-w-lg"
              >
              ...
              >
                <Button 
                  size="lg" 
                  className="text-lg px-8 py-4 h-14 bg-teal-600 hover:bg-teal-700 text-white border border-teal-500 shadow-lg hover:shadow-xl transition-all duration-200 font-semibold"
            ...
            >
              ...
              <div className="relative">
                <div className="w-80 h-96 bg-white rounded-[2.5rem] p-6 shadow-2xl transform rotate-6 hover:rotate-3 transition-transform duration-300">
                  <div className="w-full h-full bg-gradient-to-br from-teal-50 to-cyan-100 rounded-2xl p-4 flex flex-col">
                    {/* Header */}
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 -right-4 w-12 h-12 bg-teal-500 rounded-full flex items-center justify-center shadow-lg"
                >
                ...
                >
                  <span className="text-teal-600 font-bold text-sm">+15%</span>
                </motion.div>
              </div>
        ...
        <div className="absolute inset-x-0 bottom-0 -z-10 transform-gpu overflow-hidden">
          <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-teal-400 to-cyan-500 opacity-10 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" />
        </div>
      </section>
