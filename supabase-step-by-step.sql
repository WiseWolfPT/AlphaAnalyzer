...
-- ========================================
-- PARTE 1: LIMPAR E PREPARAR
-- ========================================

-- Remover triggers antigos que podem estar causando problema
...
-- Renomear a tabela price_alerts problemática
...
-- ========================================
-- PARTE 6: CRIAR TRIGGERS (SOMENTE APÓS CONFIRMAR QUE AS TABELAS EXISTEM)
-- ========================================
